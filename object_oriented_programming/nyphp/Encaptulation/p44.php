...
class enc
{
    private $p=10;//this is private variable usually it is not possible to access outside the class
    function mn(){
...
//using this object we cant call p variable which is in enc class
echo $obj->mn();
